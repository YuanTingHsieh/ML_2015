...
param = {'booster':gblinear, 'eta':0.05, 'silent':1, 'objective':'binary:logistic'}
...
f = open('XGB_5_005_08_07_500_all_0111_cla_train.csv','wb')
for i in range(0,len(sample_train_x)-1):
    f.write(str(sample_train_x[i+1,0])+','+str(int(pred_train[i]))+'\n')
f = open('XGB_5_005_08_07_500_all_0111_cla_test.csv','wb')
