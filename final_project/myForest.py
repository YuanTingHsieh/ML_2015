...
parameters = {'n_estimators':[2000],'max_depth':range(10,15,1),'n_jobs':[5],'oob_score':[False]}
#clf = RandomForestClassifier( n_estimators=2000, max_depth=10,n_jobs=5,oob_score=False)
...
print 'Correct is '
print np.sum(pred_train==label_train)/float(len(label_train))
