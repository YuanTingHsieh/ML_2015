...
param = {'max_depth':5, 'eta':0.05, 'silent':1, 'objective':'reg:logistic','subsample':0.8,'colsample_bytree':0.7,'eval_metric':'map@14400','nthread':5}
...
param = {'max_depth':5, 'eta':0.05, 'silent':1, 'objective':'binary:logistic','subsample':0.8,'colsample_bytree':0.7,'eval_metric':'auc'}
num_round = 500
...
f = open('XGB_5_005_08_07_500_all0111_reg_train.csv','wb')
for i in range(0,len(pred_train)):
    f.write(str(sample_train_x[i+1,0])+','+str((pred_train[i]))+'\n')
f = open('XGB_5_005_08_07_500_all0111_reg_test.csv','wb')
